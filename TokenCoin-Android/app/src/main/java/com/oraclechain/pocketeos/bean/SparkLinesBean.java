...
public class SparkLinesBean {
    ...
    public static class DataBean {
        ...
        private String sparkline_token_png;
        public String getSparkline_token_png() {
            return sparkline_token_png == null ? "" : sparkline_token_png;
        }

        public void setSparkline_token_png(String sparkline_token_png) {
            this.sparkline_token_png = sparkline_token_png;
        }
