...
public class BaseUrl {
    ...
    public final static String HTTP_CHAIN_ADDRESS = "http://192.168.31.245:8888/v1/chain/";
    public final static String HTTP_CANDY_ADDRESS = "http://59.110.162.106:9999/api_oc_pe_candy_system/";
        // 获取走势图
    public final static String HTTP_eos_get_pairs = HTTP_CHAIN_ADDRESS + "get_pairs";
    // 获取关注列表
    ...
    // 获取区块链状态
    public final static String HTTP_get_chain_info = HTTP_CHAIN_ADDRESS + "get_info2";
    // 交易JSON序列化
    public final static String HTTP_get_abi_json_to_bin = HTTP_CHAIN_ADDRESS + "abi_json_to_bin2";
    // 获取keys
    public final static String HTTP_get_required_keys = HTTP_CHAIN_ADDRESS + "get_required_keys2";
    // 发起交易
    public final static String HTTP_push_transaction = HTTP_CHAIN_ADDRESS + "push_transaction2";
    // 获取交易历史
    public final static String HTTP_get_transaction_history = HTTP_CHAIN_ADDRESS + "get_transactions";
        // 获取交易历史
    public final static String HTTP_get_pair_transaction_history = HTTP_CHAIN_ADDRESS + "get_pair_transactions";
    // 获取区块链账号信息
    public final static String HTTP_get_chain_account_info = HTTP_CHAIN_ADDRESS + "get_account_app";
    // 设置主账号
