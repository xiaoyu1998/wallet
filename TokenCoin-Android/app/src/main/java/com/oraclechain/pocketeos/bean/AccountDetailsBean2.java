 ...
 */
public class AccountDetailsBean2 {

    private String account_name;
    private String account_icon;
    private List<asset_data> account_assets;
    ...
    public List<asset_data> getAccount_assets() {
            if (account_assets == null) {
                return new ArrayList<>();
            }
            return account_assets;
        }

    public void setAccount_assets(List<asset_data> account_assets) {
        this.account_assets = account_assets;
    }
