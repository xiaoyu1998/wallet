...
#define REQUEST_BASEURL @"http://192.168.31.245:8888"
...
- (AFHTTPSessionManager *)networkingManager{
    if(!_networkingManager){
        ...
        _networkingManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json; charset=utf-8", @"text/html",@"text/json", @"text/javascript", @"text/plain", nil];
        
        //_networkingManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/x-www-form-urlencoded; charset=utf-8", @"text/html",@"text/json", @"text/javascript", @"text/plain", nil];
    }
