...
-(void)setUpAllChildViewController{
    ...
    [self setupChildViewController:dappVC title:@"交易" imageName:@"application_unSelect" seleceImageName:@"application_select" BB_imageName:@"application_unSelect_BB" BB_seleceImageName:@"application_select_BB"];
    
    if (LEETHEME_CURRENTTHEME_IS_SOCAIL_MODE) {
        RichListMainViewController *richListVC = [[RichListMainViewController alloc]init];
        [self setupChildViewController:richListVC title:@"我" imageName:@"richList_unSelect" seleceImageName:@"richList_select" BB_imageName:@"" BB_seleceImageName:@""];
    }
