...
@property(nonatomic, strong) TransactionRecordsService2 *mainService;
...
- (TransactionRecordsService2 *)mainService{
    if (!_mainService) {
        _mainService = [[TransactionRecordsService2 alloc] init];
    }
    return _mainService;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TransactionRecord2 *model = self.mainService.dataSourceArray[indexPath.row];
